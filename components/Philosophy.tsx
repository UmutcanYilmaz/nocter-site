    ...
    <section ref={container} className="h-screen bg-black text-white relative overflow-hidden font-sans selection:bg-[#D4AF37] selection:text-black cursor-default">
      ...
      <div ref={scene6_Concentration} className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6">
        <div className="relative">
          <h1 className="conc-number text-[12rem] md:text-[25rem] font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-[#050505] leading-none tracking-tighter select-none">
            SAF
          </h1>
        ...
        <p className="conc-sub mt-[-2rem] md:mt-[-4rem] text-[#D4AF37] tracking-[0.3em] uppercase text-sm md:text-base border border-[#D4AF37]/20 px-8 py-3 rounded-full bg-black">
          YOĞUN PARFÜM ÖZÜ
        </p>
      </div>
